...
1. Create a ModelCheckpoint callback to monitor the val_accuracy during training. 
...
with any metric you want, such as loss, or accuracy. 
...
Run the below code to download the training_log file.
